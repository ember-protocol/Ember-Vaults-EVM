 ...
 *
 * Usage:
 * - Set VAULT_KEY environment variable with comma-separated vault keys to upgrade
 *   Example: VAULT_KEY=emberErcusdcVault,emberErcethVault yarn upgrade:vaults
...
async function main() {
  ...
  const vaultKeysEnv = process.env.VAULT_KEY;
